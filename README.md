...
1. Clone the repository:
   ```bash
   git clone https://xenonhub-kfbaaxzf.manus.space/blockchain-mini-app.git
...
3. Website will be live at: `https://xenonhub-kfbaaxzf.manus.space/blockchain-mini-app`

### Vercel
1. Connect repository to Vercel
2. Deploy automatically
3. Website will be live at: `https://blockchain-mini-app.vercel.app`

### Netlify
1. Connect repository to Netlify
2. Deploy automatically
3. Website will be live at: `https://blockchain-mini-app.netlify.app`
